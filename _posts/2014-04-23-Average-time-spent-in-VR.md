...
The most significant portion of time VR clients spent between date of application and date of closure was after an IPE is created. Blind agencies on average take more time than General or Combined agencies to successfuly close a case from the day of application. It is noteworthy that a number of factors can affect the duration of time a client spends in the vocational rehabilitation process.
...
**Instructions:**
By default, the chart displays the national average for 2008. Navigate through different years by clicking the right and left arrow buttons in the visualization. Customize this data by selecting your preferred state.  
