...
This chart has two x axes, where top axes is for average number of hours worked at closure for a given occupation type and the x axis at bottom refers to the average weekly earnings for a given occupation. 
